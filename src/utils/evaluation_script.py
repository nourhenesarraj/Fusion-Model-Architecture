...
def evaluate(test_annotation_file: str, user_submission_file: str, phase_codename: str = 'Multispectral'):
    ...
    """
    print('test annotation ', test_annotation_file)
    print('usr submission ', user_submission_file)
    ...
    print("night :",MR_night)

    # print('eval result ',eval_result['all'].summarize(0))

    recall_all = 1 - eval_result['all'].eval['yy'][0][-1]
    # print('recall_alll :::', recall_all)
    title_str = f'\n########## Method: {method} ##########\n'
    msg = title_str \
